...
public class DistributedDelayQueueExample {
    ...
    private static final String PATH = "/com/farhad/example/basic/delayQueue" ;
    ...
    private static QueueConsumer<String> createQueueConsumer() {
        ...
        return new QueueConsumer<String>() {
            ...
            public void consumeMessage(String message) throws Exception {
                log.info("#### {} Consume one message: {}", new Date().getTime(),  message);
            }
    ...
    public static void main(String[] args) {
        ...
        DistributedDelayQueue<String> delayQueue = null;
        try {
            ...
            delayQueue = builder.buildDelayQueue();

            delayQueue.start();

            for (int i = 0; i < 10; i++) {

                delayQueue.put("message-" + i, System.currentTimeMillis() + 10_000);
                
            }

            log.info("#### {} : already put all items", new Date().getTime());
